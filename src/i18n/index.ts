...
const EN: Dict = {
  ...
  'nav.today': 'Today',
  'nav.earlier': 'Earlier',
  'nav.deleteAd': 'Delete ad',
  'nav.noRecent': 'No ads yet — start one above.',
  ...
  // ── Crypto checkout (pay on-chain to unlock a tier) ──
  'pay.section': 'Or pay with crypto',
  'pay.sectionHint': 'Pay on-chain from your own wallet — no card, no processor.',
  'pay.payTier': 'Pay for {tier}',
  'pay.title': 'Pay with crypto',
  'pay.subtitle': 'Unlock {tier}, paid on-chain — non-custodial.',
  'pay.unavailable': "Crypto payment isn't available right now.",
  'pay.loading': 'Loading payment options…',
  'pay.choose': 'Choose how to pay',
  'pay.chooseHint': 'Pick a coin and network, then pay from your wallet.',
  'pay.priceLine': '{tier} is ${usd}, paid once.',
  'pay.amount': 'Amount to send',
  'pay.network': 'Network',
  'pay.usdValue': '≈ ${usd}',
  'pay.address': 'Send to this address',
  'pay.copy': 'Copy',
  'pay.copied': 'Copied',
  'pay.instructions':
    'Send at least this amount on {network} from your own wallet, then paste the transaction hash below to unlock {tier}.',
  'pay.txHash': 'Transaction hash',
  'pay.txHashPlaceholder': 'Paste the transaction hash / signature',
  'pay.back': 'Back',
  'pay.expiresIn': 'Quote valid for {time}',
  'pay.newQuote': 'New quote',
  'pay.verify': 'Verify payment',
  'pay.verifying': 'Verifying on-chain…',
  'pay.success': "Payment confirmed — you're on {tier} now.",
  'pay.err.notFound':
    "That transaction isn't visible yet. If you just sent it, wait for a confirmation and try again.",
  'pay.err.unconfirmed': 'Not enough confirmations yet — wait a moment and verify again.',
  'pay.err.mismatch': "That transaction doesn't match this order's amount or address.",
  'pay.err.reused': 'That transaction was already used for another order.',
  'pay.err.expired': 'This quote expired — start a new one.',
  'pay.err.unsupported': "That coin or network isn't available.",
  'pay.err.price': "Couldn't fetch a live price. Try again in a moment.",
...
const JA: Dict = {
  ...
  'tier.redeemTitle': "Pro または Ultra のキーをお持ちですか？",
  'tier.redeemPlaceholder': "ティアキーを貼り付け",
  'tier.redeemCta': "引き換える",
  'tier.redeemSuccess': "現在 {tier} プランです。",
  'tier.redeemInvalid': "そのキーは認識できませんでした。",
  'tier.platformLocked': "Meta・X 広告 — Ultra 限定",
  'tier.platformLockedBody': "プラットフォーム対応の Meta・X 広告書き出しは Ultra の機能です。設定で Ultra キーを引き換えると利用できます。",
  'settings.navAccount': "アカウント",
  'settings.navGeneration': "生成",
  'settings.navBrand': "ブランド",
  'settings.navData': "データ管理",
  'settings.change': "変更",
  'settings.newAdHint': "現在のブリーフを消去して最初からやり直します。",
  'nav.newAd': "新しい広告",
  'nav.search': "検索",
  'nav.settings': "設定",
  'nav.upgrade': "アップグレード",
  'nav.upgradePlan': "プランをアップグレード",
  'nav.account': "アカウント",
  'nav.signOut': "サインアウト",
  'nav.recent': "現在の広告",
  'nav.history': "履歴",
  ...
  'nav.earlier': "それ以前",
  'nav.deleteAd': "広告を削除",
  'nav.noRecent': "まだ広告はありません — 上から作成してください。",
  'nav.collapse': "サイドバーを折りたたむ",
  'nav.expand': "サイドバーを展開",
  'nav.private': "プライベート",
  'nav.privateHint': "ここでの内容は共有されません。生成はあなたのバックエンドを通じて実行されます。",
  'nav.untitledAd': "無題の広告",
  'upgrade.title': "Personify Ads のすべての機能を解放",
  'upgrade.subtitle': "プランを選び、下でキーを引き換えてください。",
  'upgrade.currentPlan': "現在のプラン",
  'upgrade.yourPlan': "ご利用中",
  'upgrade.cta': "キーをお持ちですか？下で引き換え",
  'upgrade.redeemTitle': "Pro または Ultra のキーを引き換える",
  'upgrade.close': "閉じる",
  'upgrade.perMonth': "/月",
  'upgrade.free.name': "Free",
  'upgrade.free.price': "$0",
  'upgrade.free.tagline': "基本パイプラインを試す",
  'upgrade.free.f1': "コピー・画像・スクリプト・音声のステップ",
  'upgrade.free.f2': "高速画像モデル",
  'upgrade.free.f3': "利用量に上限あり、カード不要",
  'upgrade.pro.name': "Pro",
  'upgrade.pro.price': "$19",
  'upgrade.pro.tagline': "フルクリエイティブパイプライン",
  'upgrade.pro.f1': "オーディエンスとデザインを含む全6ステップ",
  'upgrade.pro.f2': "高速＋バランス画質",
  'upgrade.pro.f3': "より高い利用上限",
  'upgrade.ultra.name': "Ultra",
  'upgrade.ultra.price': "$49",
  'upgrade.ultra.tagline': "すべて、最高画質",
  'upgrade.ultra.f1': "リアル（Flux Pro）画像",
  'upgrade.ultra.f2': "Kling AI 動画クリップ",
  'upgrade.ultra.f3': "Meta・X プラットフォーム広告の書き出し",

  // ── Crypto checkout ──
  'pay.section': 'または暗号資産で支払う',
  'pay.sectionHint': '自分のウォレットからオンチェーン支払い — カード不要、プロセッサー不要。',
  'pay.payTier': '{tier}の支払い',
  'pay.title': '暗号資産で支払う',
  'pay.subtitle': '{tier}のロックを解除、オンチェーン支払い — ノンカストディアル。',
  'pay.unavailable': '暗号資産払いは現在利用できません。',
  'pay.loading': '支払いオプションを読み込み中…',
  'pay.choose': '支払い方法を選ぶ',
  'pay.chooseHint': 'コインとネットワークを選んでから、ウォレットから支払います。',
  'pay.priceLine': '{tier}は${usd}で、1回限りの支払いです。',
  'pay.amount': '送信額',
  'pay.network': 'ネットワーク',
  'pay.usdValue': '≈ ${usd}',
  'pay.address': 'このアドレスに送信',
  'pay.copy': 'コピー',
  'pay.copied': 'コピーしました',
  'pay.instructions': '{network}でこの額以上を自分のウォレットから送信し、下のトランザクションハッシュを貼り付けて{tier}をロック解除してください。',
  'pay.txHash': 'トランザクションハッシュ',
  'pay.txHashPlaceholder': 'トランザクションハッシュ / シグネチャを貼り付け',
  'pay.back': '戻る',
  'pay.expiresIn': 'クォート有効期限 {time}',
  'pay.newQuote': '新しいクォート',
  'pay.verify': '支払いを確認',
  'pay.verifying': 'オンチェーン確認中…',
  'pay.success': '支払いが確認されました — {tier}にアップグレードしました。',
  'pay.err.notFound': 'そのトランザクションはまだ表示されていません。送信したばかりの場合は、確認を待ってからもう一度試してください。',
  'pay.err.unconfirmed': '確認数が不足しています — 少し待ってから検証してください。',
  'pay.err.mismatch': 'そのトランザクションはこの注文の金額またはアドレスと一致しません。',
  'pay.err.reused': 'そのトランザクションは既に別の注文で使用されています。',
  'pay.err.expired': 'このクォートは期限切れです — 新しいものを開始してください。',
  'pay.err.unsupported': 'そのコインまたはネットワークは利用できません。',
...
const PT: Dict = {
  ...
  'tier.redeemTitle': "Tem uma chave Pro ou Ultra?",
  'tier.redeemPlaceholder': "Cole a chave do plano",
  'tier.redeemCta': "Resgatar",
  'tier.redeemSuccess': "Você está no {tier} agora.",
  'tier.redeemInvalid': "Essa chave não foi reconhecida.",
  'tier.platformLocked': "Anúncios Meta e X — só no Ultra",
  'tier.platformLockedBody': "A exportação de anúncios prontos para Meta e X é um recurso do Ultra. Resgate uma chave Ultra nas Configurações para desbloquear.",
  'settings.navAccount': "Conta",
  'settings.navGeneration': "Geração",
  'settings.navBrand': "Marca",
  'settings.navData': "Controles de dados",
  'settings.change': "Alterar",
  'settings.newAdHint': "Limpar o briefing atual e começar de novo.",
  'nav.newAd': "Novo anúncio",
  'nav.search': "Buscar",
  'nav.settings': "Configurações",
  'nav.upgrade': "Fazer upgrade",
  'nav.upgradePlan': "Atualizar plano",
  'nav.account': "Conta",
  'nav.signOut': "Sair",
  'nav.recent': "Anúncio atual",
  'nav.history': "Histórico",
  'nav.today': "Hoje",
  'nav.earlier': "Anteriores",
  'nav.deleteAd': "Excluir anúncio",
  'nav.noRecent': "Nenhum anúncio ainda — crie um acima.",
  'nav.collapse': "Recolher barra lateral",
  'nav.expand': "Expandir barra lateral",
  'nav.private': "Privado",
  'nav.privateHint': "Nada aqui é compartilhado. A geração passa pelo seu backend.",
  'nav.untitledAd': "Anúncio sem título",
  'upgrade.title': "Libere todo o poder do Personify Ads",
  'upgrade.subtitle': "Escolha um plano e resgate sua chave abaixo.",
  'upgrade.currentPlan': "Plano atual",
  'upgrade.yourPlan': "Seu plano",
  'upgrade.cta': "Tem uma chave? Resgate abaixo",
  'upgrade.redeemTitle': "Resgatar uma chave Pro ou Ultra",
  'upgrade.close': "Fechar",
  'upgrade.perMonth': "/mês",
  'upgrade.free.name': "Free",
  'upgrade.free.price': "$0",
  'upgrade.free.tagline': "Experimente o fluxo principal",
  'upgrade.free.f1': "Etapas de Texto, Imagem, Roteiro e Áudio",
  'upgrade.free.f2': "Modelo de imagem rápido",
  'upgrade.free.f3': "Uso limitado, sem cartão",
  'upgrade.pro.name': "Pro",
  'upgrade.pro.price': "$19",
  'upgrade.pro.tagline': "O fluxo criativo completo",
  'upgrade.pro.f1': "Todas as seis etapas, incl. Público e Design",
  'upgrade.pro.f2': "Qualidade de imagem rápida + equilibrada",
  'upgrade.pro.f3': "Limite de uso maior",
  'upgrade.ultra.name': "Ultra",
  'upgrade.ultra.price': "$49",
  'upgrade.ultra.tagline': "Tudo, qualidade máxima",
  'upgrade.ultra.f1': "Imagens realistas (Flux Pro)",
  'upgrade.ultra.f2': "Clipes de vídeo Kling AI",
  'upgrade.ultra.f3': "Exportação de anúncios para Meta e X",

  // ── Crypto checkout ──
  'pay.section': 'Ou pague com criptomoedas',
  'pay.sectionHint': 'Pague na cadeia a partir de sua própria carteira — sem cartão, sem processador.',
  'pay.payTier': 'Pagar por {tier}',
  'pay.title': 'Pagar com criptomoedas',
  'pay.subtitle': 'Desbloqueie {tier}, pago na cadeia — não-custodial.',
  'pay.unavailable': 'Pagamento com criptomoedas não está disponível no momento.',
  'pay.loading': 'Carregando opções de pagamento…',
  'pay.choose': 'Escolha como pagar',
  'pay.chooseHint': 'Escolha uma moeda e rede, depois pague de sua carteira.',
  'pay.priceLine': '{tier} custa ${usd}, pago uma vez.',
  'pay.amount': 'Valor a enviar',
  'pay.network': 'Rede',
  'pay.usdValue': '≈ ${usd}',
  'pay.address': 'Enviar para este endereço',
  'pay.copy': 'Copiar',
  'pay.copied': 'Copiado',
  'pay.instructions': 'Envie pelo menos este valor na {network} de sua própria carteira, depois cole o hash da transação abaixo para desbloquear {tier}.',
  'pay.txHash': 'Hash da transação',
  'pay.txHashPlaceholder': 'Cole o hash da transação / assinatura',
  'pay.back': 'Voltar',
  'pay.expiresIn': 'Cotação válida por {time}',
  'pay.newQuote': 'Nova cotação',
  'pay.verify': 'Verificar pagamento',
  'pay.verifying': 'Verificando na cadeia…',
  'pay.success': 'Pagamento confirmado — você está em {tier} agora.',
  'pay.err.notFound': 'Essa transação não está visível ainda. Se acabou de enviar, aguarde uma confirmação e tente novamente.',
  'pay.err.unconfirmed': 'Não há confirmações suficientes ainda — aguarde um momento e verifique novamente.',
  'pay.err.mismatch': 'Essa transação não corresponde ao valor ou endereço desta ordem.',
  'pay.err.reused': 'Essa transação já foi usada em outra ordem.',
  'pay.err.expired': 'Esta cotação expirou — inicie uma nova.',
  'pay.err.unsupported': 'Essa moeda ou rede não está disponível.',
...
const ES: Dict = {
  ...
  'tier.redeemTitle': "¿Tienes una clave Pro o Ultra?",
  'tier.redeemPlaceholder': "Pega la clave del plan",
  'tier.redeemCta': "Canjear",
  'tier.redeemSuccess': "Ahora estás en {tier}.",
  'tier.redeemInvalid': "No se reconoció esa clave.",
  'tier.platformLocked': "Anuncios de Meta y X — solo Ultra",
  'tier.platformLockedBody': "La exportación de anuncios listos para Meta y X es una función de Ultra. Canjea una clave Ultra en Ajustes para desbloquearla.",
  'settings.navAccount': "Cuenta",
  'settings.navGeneration': "Generación",
  'settings.navBrand': "Marca",
  'settings.navData': "Control de datos",
  'settings.change': "Cambiar",
  'settings.newAdHint': "Borrar el brief actual y empezar de nuevo.",
  ...
  'nav.recent': "Anuncio actual",
  'nav.history': "Historial",
  'nav.today': "Hoy",
  'nav.earlier': "Anteriores",
  'nav.deleteAd': "Eliminar anuncio",
  'nav.noRecent': "Aún no hay anuncios — crea uno arriba.",
  'nav.collapse': "Contraer barra lateral",
  'nav.expand': "Expandir barra lateral",
  'nav.private': "Privado",
  'nav.privateHint': "Nada de aquí se comparte. La generación pasa por tu backend.",
  'nav.untitledAd': "Anuncio sin título",
  'upgrade.title': "Desbloquea todo el potencial de Personify Ads",
  'upgrade.subtitle': "Elige un plan y canjea tu clave abajo.",
  'upgrade.currentPlan': "Plan actual",
  'upgrade.yourPlan': "Tu plan",
  'upgrade.cta': "¿Tienes una clave? Canjéala abajo",
  'upgrade.redeemTitle': "Canjear una clave Pro o Ultra",
  'upgrade.close': "Cerrar",
  'upgrade.perMonth': "/mes",
  'upgrade.free.name': "Free",
  'upgrade.free.price': "$0",
  'upgrade.free.tagline': "Prueba el flujo básico",
  'upgrade.free.f1': "Pasos de Texto, Imagen, Guion y Audio",
  'upgrade.free.f2': "Modelo de imagen rápido",
  'upgrade.free.f3': "Uso limitado, sin tarjeta",
  'upgrade.pro.name': "Pro",
  'upgrade.pro.price': "$19",
  'upgrade.pro.tagline': "El flujo creativo completo",
  'upgrade.pro.f1': "Los seis pasos, incl. Audiencia y Diseño",
  'upgrade.pro.f2': "Calidad de imagen rápida + equilibrada",
  'upgrade.pro.f3': "Límite de uso mayor",
  'upgrade.ultra.name': "Ultra",
  'upgrade.ultra.price': "$49",
  'upgrade.ultra.tagline': "Todo, máxima calidad",
  'upgrade.ultra.f1': "Imágenes realistas (Flux Pro)",
  'upgrade.ultra.f2': "Clips de vídeo Kling AI",
  'upgrade.ultra.f3': "Exportación de anuncios para Meta y X",

  // ── Crypto checkout ──
  'pay.section': 'O paga con criptomoneda',
  'pay.sectionHint': 'Paga desde tu wallet — sin tarjeta, sin intermediario.',
  'pay.payTier': 'Pagar por {tier}',
  'pay.title': 'Pagar con criptomoneda',
  'pay.subtitle': 'Desbloquea {tier}, pago en-cadena — sin custodia.',
  'pay.unavailable': 'El pago con criptomoneda no está disponible en este momento.',
  'pay.loading': 'Cargando opciones de pago…',
  'pay.choose': 'Elige cómo pagar',
  'pay.chooseHint': 'Elige una moneda y red, después paga desde tu wallet.',
  'pay.priceLine': '{tier} cuesta ${usd}, pago único.',
  'pay.amount': 'Cantidad a enviar',
  'pay.network': 'Red',
  'pay.usdValue': '≈ ${usd}',
  'pay.address': 'Envía a esta dirección',
  'pay.copy': 'Copiar',
  'pay.copied': 'Copiado',
  'pay.instructions': 'Envía al menos esta cantidad en {network} desde tu wallet, después pega el hash de transacción abajo para desbloquear {tier}.',
  'pay.txHash': 'Hash de transacción',
  'pay.txHashPlaceholder': 'Pega el hash de transacción / firma',
  'pay.back': 'Atrás',
  'pay.expiresIn': 'Cotización válida por {time}',
  'pay.newQuote': 'Nueva cotización',
  'pay.verify': 'Verificar pago',
  'pay.verifying': 'Verificando en-cadena…',
  'pay.success': 'Pago confirmado — ahora estás en {tier}.',
  'pay.err.notFound': 'Esa transacción aún no es visible. Si la acabas de enviar, espera a una confirmación e inténtalo de nuevo.',
  'pay.err.unconfirmed': 'No hay suficientes confirmaciones aún — espera un momento y verifica de nuevo.',
  'pay.err.mismatch': 'Esa transacción no coincide con el monto o la dirección de este pedido.',
  'pay.err.reused': 'Esa transacción ya fue usada para otro pedido.',
  'pay.err.expired': 'Esta cotización expiró — comienza una nueva.',
  'pay.err.unsupported': 'Esa moneda o red no está disponible.',
...
const FR: Dict = {
  ...
  'tier.redeemTitle': "Vous avez une clé Pro ou Ultra ?",
  'tier.redeemPlaceholder': "Collez la clé du forfait",
  'tier.redeemCta': "Activer",
  'tier.redeemSuccess': "Vous êtes maintenant sur {tier}.",
  'tier.redeemInvalid': "Cette clé n'a pas été reconnue.",
  'tier.platformLocked': "Publicités Meta et X — Ultra uniquement",
  'tier.platformLockedBody': "L'export de publicités prêtes pour Meta et X est une fonctionnalité Ultra. Activez une clé Ultra dans les Paramètres pour le débloquer.",
  'settings.navAccount': "Compte",
  'settings.navGeneration': "Génération",
  'settings.navBrand': "Marque",
  'settings.navData': "Contrôle des données",
  'settings.change': "Modifier",
  'settings.newAdHint': "Effacer le brief actuel et recommencer.",
  'nav.newAd': "Nouvelle publicité",
  'nav.search': "Rechercher",
  'nav.settings': "Paramètres",
  'nav.upgrade': "Améliorer",
  'nav.upgradePlan': "Changer de forfait",
  'nav.account': "Compte",
  'nav.signOut': "Se déconnecter",
  'nav.recent': "Publicité actuelle",
  'nav.history': "Historique",
  'nav.today': "Aujourd'hui",
  'nav.earlier': "Plus tôt",
  'nav.deleteAd': "Supprimer la publicité",
  'nav.noRecent': "Aucune publicité pour l'instant — créez-en une ci-dessus.",
  'nav.collapse': "Réduire la barre latérale",
  'nav.expand': "Développer la barre latérale",
  'nav.private': "Privé",
  'nav.privateHint': "Rien ici n'est partagé. La génération passe par votre backend.",
  'nav.untitledAd': "Publicité sans titre",
  'upgrade.title': "Débloquez toute la puissance de Personify Ads",
  'upgrade.subtitle': "Choisissez un forfait, puis activez votre clé ci-dessous.",
  'upgrade.currentPlan': "Forfait actuel",
  'upgrade.yourPlan': "Votre forfait",
  'upgrade.cta': "Vous avez une clé ? Activez-la ci-dessous",
  'upgrade.redeemTitle': "Activer une clé Pro ou Ultra",
  'upgrade.close': "Fermer",
  'upgrade.perMonth': "/mois",
  'upgrade.free.name': "Free",
  'upgrade.free.price': "$0",
  'upgrade.free.tagline': "Essayez le pipeline de base",
  'upgrade.free.f1': "Étapes Texte, Image, Script et Audio",
  'upgrade.free.f2': "Modèle d'image rapide",
  'upgrade.free.f3': "Usage plafonné, sans carte",
  'upgrade.pro.name': "Pro",
  'upgrade.pro.price': "$19",
  'upgrade.pro.tagline': "Le pipeline créatif complet",
  'upgrade.pro.f1': "Les six étapes, dont Audience et Design",
  'upgrade.pro.f2': "Qualité d'image rapide + équilibrée",
  'upgrade.pro.f3': "Plafond d'usage plus élevé",
  'upgrade.ultra.name': "Ultra",
  'upgrade.ultra.price': "$49",
  'upgrade.ultra.tagline': "Tout, qualité maximale",
  'upgrade.ultra.f1': "Images réalistes (Flux Pro)",
  'upgrade.ultra.f2': "Clips vidéo Kling AI",
  'upgrade.ultra.f3': "Export de publicités pour Meta et X",

  // ── Crypto checkout ──
  'pay.section': 'Ou payer avec crypto',
  'pay.sectionHint': "Payez on-chain depuis votre portefeuille — pas de carte, pas d'intermédiaire.",
  'pay.payTier': 'Payer pour {tier}',
  'pay.title': 'Payer avec crypto',
  'pay.subtitle': 'Débloquez {tier}, payé on-chain — sans garde.',
  'pay.unavailable': "Le paiement par crypto n'est pas disponible pour le moment.",
  'pay.loading': 'Chargement des options de paiement…',
  'pay.choose': 'Choisissez comment payer',
  'pay.chooseHint': 'Sélectionnez une monnaie et un réseau, puis payez depuis votre portefeuille.',
  'pay.priceLine': '{tier} coûte ${usd}, payé une seule fois.',
  'pay.amount': 'Montant à envoyer',
  'pay.network': 'Réseau',
  'pay.usdValue': '≈ ${usd}',
  'pay.address': 'Envoyer à cette adresse',
  'pay.copy': 'Copier',
  'pay.copied': 'Copié',
  'pay.instructions': 'Envoyez au moins ce montant sur {network} depuis votre portefeuille, puis collez le hash de la transaction ci-dessous pour débloquer {tier}.',
  'pay.txHash': 'Hash de la transaction',
  'pay.txHashPlaceholder': 'Collez le hash de la transaction / signature',
  'pay.back': 'Retour',
  'pay.expiresIn': 'Cotation valide pour {time}',
  'pay.newQuote': 'Nouvelle cotation',
  'pay.verify': 'Vérifier le paiement',
  'pay.verifying': 'Vérification on-chain…',
  'pay.success': 'Paiement confirmé — vous êtes maintenant sur {tier}.',
  'pay.err.notFound': "Cette transaction n'est pas encore visible. Si vous venez de l'envoyer, attendez une confirmation et réessayez.",
  'pay.err.unconfirmed': 'Confirmations insuffisantes — attendez et vérifiez à nouveau.',
  'pay.err.mismatch': "Cette transaction ne correspond pas au montant ou à l'adresse de cette commande.",
  'pay.err.reused': 'Cette transaction a déjà été utilisée pour une autre commande.',
  'pay.err.expired': 'Cette cotation a expiré — commencez une nouvelle.',
  'pay.err.unsupported': "Cette monnaie ou ce réseau n'est pas disponible.",
...
const DE: Dict = {
  ...
  'tier.redeemTitle': "Hast du einen Pro- oder Ultra-Schlüssel?",
  'tier.redeemPlaceholder': "Tarif-Schlüssel einfügen",
  'tier.redeemCta': "Einlösen",
  'tier.redeemSuccess': "Du bist jetzt auf {tier}.",
  'tier.redeemInvalid': "Dieser Schlüssel wurde nicht erkannt.",
  'tier.platformLocked': "Meta- & X-Anzeigen — nur Ultra",
  'tier.platformLockedBody': "Der Export plattformfertiger Meta- und X-Anzeigen ist eine Ultra-Funktion. Löse in den Einstellungen einen Ultra-Schlüssel ein, um ihn freizuschalten.",
  'settings.navAccount': "Konto",
  'settings.navGeneration': "Generierung",
  'settings.navBrand': "Marke",
  'settings.navData': "Datenverwaltung",
  'settings.change': "Ändern",
  'settings.newAdHint': "Aktuelles Briefing löschen und neu beginnen.",
  'nav.newAd': "Neue Anzeige",
  'nav.search': "Suchen",
  'nav.settings': "Einstellungen",
  'nav.upgrade': "Upgrade",
  'nav.upgradePlan': "Tarif upgraden",
  'nav.account': "Konto",
  'nav.signOut': "Abmelden",
  'nav.recent': "Aktuelle Anzeige",
  'nav.history': "Verlauf",
  'nav.today': "Heute",
  'nav.earlier': "Früher",
  'nav.deleteAd': "Anzeige löschen",
  'nav.noRecent': "Noch keine Anzeigen — erstelle oben eine.",
  'nav.collapse': "Seitenleiste einklappen",
  'nav.expand': "Seitenleiste ausklappen",
  'nav.private': "Privat",
  'nav.privateHint': "Hier wird nichts geteilt. Die Generierung läuft über dein Backend.",
  'nav.untitledAd': "Unbenannte Anzeige",
  'upgrade.title': "Schalte die volle Power von Personify Ads frei",
  'upgrade.subtitle': "Wähle einen Tarif und löse unten deinen Schlüssel ein.",
  'upgrade.currentPlan': "Aktueller Tarif",
  'upgrade.yourPlan': "Dein Tarif",
  'upgrade.cta': "Hast du einen Schlüssel? Unten einlösen",
  'upgrade.redeemTitle': "Einen Pro- oder Ultra-Schlüssel einlösen",
  'upgrade.close': "Schließen",
  'upgrade.perMonth': "/Mon.",
  'upgrade.free.name': "Free",
  'upgrade.free.price': "$0",
  'upgrade.free.tagline': "Den Kern-Workflow ausprobieren",
  'upgrade.free.f1': "Schritte Text, Bild, Skript & Audio",
  'upgrade.free.f2': "Schnelles Bildmodell",
  'upgrade.free.f3': "Nutzung begrenzt, keine Karte nötig",
  'upgrade.pro.name': "Pro",
  'upgrade.pro.price': "$19",
  'upgrade.pro.tagline': "Der komplette Kreativ-Workflow",
  'upgrade.pro.f1': "Alle sechs Schritte, inkl. Zielgruppe & Design",
  'upgrade.pro.f2': "Schnelle + ausgewogene Bildqualität",
  'upgrade.pro.f3': "Höheres Nutzungslimit",
  'upgrade.ultra.name': "Ultra",
  'upgrade.ultra.price': "$49",
  'upgrade.ultra.tagline': "Alles, maximale Qualität",
  'upgrade.ultra.f1': "Realistische Bilder (Flux Pro)",
  'upgrade.ultra.f2': "Kling-AI-Videoclips",
  'upgrade.ultra.f3': "Anzeigen-Export für Meta & X",

  // ── Crypto checkout ──
  'pay.section': 'Oder mit Krypto bezahlen',
  'pay.sectionHint': 'Zahle direkt aus deinem Wallet — keine Karte, kein Zahlungsdienstleister.',
  'pay.payTier': 'Zahle für {tier}',
  'pay.title': 'Mit Krypto bezahlen',
  'pay.subtitle': 'Schalte {tier} frei, direkt auf der Blockchain — dezentral.',
  'pay.unavailable': 'Kryptobezahlung ist gerade nicht verfügbar.',
  'pay.loading': 'Zahlungsoptionen werden geladen…',
  'pay.choose': 'Wähle wie du bezahlen möchtest',
  'pay.chooseHint': 'Wähle eine Münze und ein Netzwerk, dann zahle von deinem Wallet.',
  'pay.priceLine': '{tier} kostet ${usd}, einmalige Zahlung.',
  'pay.amount': 'Zu zahlender Betrag',
  'pay.network': 'Netzwerk',
  'pay.usdValue': '≈ ${usd}',
  'pay.address': 'Überweise an diese Adresse',
  'pay.copy': 'Kopieren',
  'pay.copied': 'Kopiert',
  'pay.instructions': 'Sende mindestens diesen Betrag im {network}-Netzwerk von deinem eigenen Wallet und füge dann den Transaktions-Hash unten ein, um {tier} freizuschalten.',
  'pay.txHash': 'Transaktions-Hash',
  'pay.txHashPlaceholder': 'Transaktions-Hash / Signatur einfügen',
  'pay.back': 'Zurück',
  'pay.expiresIn': 'Angebot gültig für {time}',
  'pay.newQuote': 'Neues Angebot',
  'pay.verify': 'Zahlung bestätigen',
  'pay.verifying': 'Prüfe auf der Blockchain…',
  'pay.success': 'Zahlung bestätigt — du bist jetzt auf {tier}.',
  'pay.err.notFound': 'Diese Transaktion ist noch nicht sichtbar. Falls du sie gerade gesendet hast, warte auf eine Bestätigung und versuche es erneut.',
  'pay.err.unconfirmed': 'Noch nicht genug Bestätigungen — warte einen Moment und prüfe dann erneut.',
  'pay.err.mismatch': 'Diese Transaktion passt nicht zu Betrag oder Adresse dieser Bestellung.',
  'pay.err.reused': 'Diese Transaktion wurde bereits für eine andere Bestellung verwendet.',
  'pay.err.expired': 'Dieses Angebot ist abgelaufen — erstelle ein neues.',
  'pay.err.unsupported': 'Diese Münze oder dieses Netzwerk ist nicht verfügbar.',
